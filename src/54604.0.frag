/*
 * Original shader from: https://www.shadertoy.com/view/4sSXDG
 */
...
vec3 flyerPos = vec3(0.), engPos = vec3(0.), qHit = vec3(0.), qHitTransObj = vec3(0.), sunDir = vec3(0.), sunCol = vec3(0.);
vec2 trkOffset = vec2(0.);
float szFac = 0., wSpan = 0., tCur = 0.;
