/*
 * Original shader from: https://www.shadertoy.com/view/3dSXRm
 */
...
vec2 sc,y,e=vec2(.000035,-.000035);float t=0.,tt=0.,b=0.,de,cr=1.;vec3 np,bp,cp=vec3(0.),po;vec4 cc,su=vec4(0);//Some fucking globals, about as exciting as hippies lecturing you about enlightenment
