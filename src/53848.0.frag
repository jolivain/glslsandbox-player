/*
 * Original shader from: https://www.shadertoy.com/view/4t2cR1
 */
...
#define texelFetch(s, uv, lod) vec4(0.75)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    sceneColor = pow(sceneColor, vec3(1.)) * texelFetch(iChannel0, ivec2(128, 0), 0).r * min(1., iChannelTime[0] * .1);
