/*
 * Original shader from: https://www.shadertoy.com/view/ttXGWH
 */
...
/*
	...
	artistic vision of a programmer. :)
	...
	Beeple inspired shaders lately, and I've been meaning to do the same.
	...
	Having said that, I went to the trouble to blend materials when the shiny 
	objects were near the terrain. That involved a little bit of fiddly mixing,
	which complicated the code a little, but nothing that anyone here couldn't
	handle. :)
...
vec4 objID = vec4(0.), oSvObjID = vec4(0.);
